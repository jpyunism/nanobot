...
Use your primary madkoding/nanobot remote in place of `upstream` if your checkout
...
Please feel free to open an [issue](https://github.com/madkoding/nanobot/issues), join the community, or simply reach out:
