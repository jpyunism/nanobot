...
- [x] **T1.1 Reasoning delta acumula y abre draft**
...
- [x] **T1.2 Reasoning en legacy (grupos / rich off)**
...
- [x] **T1.3 Fijación con draft_id + details final**
...
- [x] **T1.4 Fallback por expiración del draft**
...
- [x] **T1.5 Fallback por fallo de fijación**
