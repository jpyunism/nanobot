...
- [ ] **T1.1 Test de regresión: sin effect y sin config → sin message_effect_id**
...
- [ ] **T2.1 `_resolve_message_effect` sin default confeti**
...
- [ ] **T2.2 Actualizar test de default por config**
...
- [ ] **T3.1 Actualizar spec UX existente (D3/REQ-007)**
...
- [ ] **T4.2 Commit, fork y PR a madkoding**
...
- [ ] **T4.3 Sync site-packages + aviso reinicio**
