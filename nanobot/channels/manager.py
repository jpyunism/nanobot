        ...
        *,
        ...
        while True:
            ...
            try:
                ...
                # whatsapp blocks first-message sends to new contacts with
                # error 463 (see whatsmeow #1197). Retrying just keeps the
                # server-side block active longer, so fail fast.
